...
<journal>
  <transaction type="Sale Packing List">
    ...
    self.assertRelatedObjectCount(project, 129)
...
<journal>
  <transaction type="Sale Packing List">
    ...
    # 1 software product
    # 4 subscription requests
    self.assertRelatedObjectCount(project, 139)
...
<journal>
  <transaction type="Sale Packing List">
    ...
    # 1 software product
    # 4 subscription requests
    self.assertRelatedObjectCount(project, 111)
